...
In this work, we aim to use the unique information made available to us in very metal-poor (VMP) galactic systems; ultra-faint dwarfs (UFDs) and the VMP Milky Way halo (MWH) stars (which likely originate from UFD-like anal)
