...
Constraining R$_{NSM}$ is important because of the role NSMs have along with supernovae (SN) in galactic chemical evolution and in the precise 'odd-even' abundance patterns found in the Sun and d stars 
\begin{equation}
\label{eqn:drag}
