...
Constraining R$_{NSM}$ is important because of the role NSMs have along with core-collapse supernovae (SN) in galactic chemical evolution and in the precise 'odd-even' elemental abundance patterns found in the Sun and in stars that are much more metal poor. These patterns originate from the elemental yields produced from the stellar lifecycstellar nucleosynthesis, stellar evolution (especially in the asymtotic giant branch (AGB) phase), explosive stellar nucleosynthesis (i.e., SN), and $r$-process-rich nucleosynthetic events (i.e., NSM and rare-CCSN). 
