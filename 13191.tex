...
As {\it one-shot} galaxies, mostxx UFDs are expected to have only few episodes of interstellar medium (ISM) enrichment by which generations of stars are enriched and then passively evolved to the present (Brown, Tumlinson...). 
